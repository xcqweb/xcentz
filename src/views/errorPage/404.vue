<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit" style="margin-left:36px;">
        <div class="bullshit__oops">出错啦!</div>
        
        <div class="bullshit__headline">请检查网址是否正确或点击按钮返回主页</div>
        <a href="javascript:;" @click="$router.push('/')" class="bullshit__return-home" style="margin-top:20px;">返回主页</a>
      </div>
    </div>
  </div>
</template>
